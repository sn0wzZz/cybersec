...
export default function Hero() {
  return (
    <Container
      outer='bg-section-gradient py-[175px] '
      className='relative flex flex-col lg:flex-row md:py-[150px]  gap-16'
    >
      ...
      <div className=' flex flex-col gap-8 items-start z-10  max-w-[647px] shadow-[18px_20px_0px_0px_60px_hsla(235,28%,80%,0.2)] rounded-[32px]'>
        <div className='max-w-[519px] w-full p-6 bg-background dark:bg-muted flex flex-col gap-4 rounded-[32px] relative'>
          <div className='absolute bg-background dark:bg-muted shadow-[0px_44px_64px_24px_hsla(235,28%,80%,0.2)] flex p-6 rounded-3xl gap-1.5 md:-top-14 md:-right-6   top-[230px]'>
          ...
          <div className='flex gap-[105px] lg:gap-[75px] flex-col lg:flex-row'>
            <div className='max-w-[216px] w-full bg-muted dark:bg-background p-5 rounded-3xl flex flex-col gap-3'>
